    ...
    <div className="mx-auto w-[100%] lg:w-auto lg:max-w-6xl p-12 sm:px-6 lg:px-8">
      <ul role="list" className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-1">
        <li className="relative">
          <p className="pointer-events-none mt-6 block truncate text-sm font-medium text-gray-100">
            ...
            3. Add these code in your contracts<br />
          </p>
          <div className="mt-6 flex space-x-3">
            <Select list={list} />
          </div>
          <p className="pointer-events-none mt-6 block truncate text-sm font-medium text-gray-400">Your address: 0xBc1243B45dd0F0724d00F0d1175f9438A155dFEA</p>
          <p className="pointer-events-none mt-2 block truncate text-sm font-medium text-gray-400">You Have: 1 ETH</p>
          <div className="group aspect-w-10 aspect-h-7 block w-full overflow-hidden rounded-lg bg-gray-100 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 mt-4">
          ...
          <p className="pointer-events-none mt-2 block truncate text-sm font-medium text-gray-100">{current_smart_contract.title}</p>
          <p className="pointer-events-none block text-sm font-medium text-gray-300">{current_smart_contract.desc}</p>
          <button
      ...
      <div className="w-[100%] mt-6">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h1 className="text-xl font-semibold text-gray-200">KOL Of This Project
            </h1>
